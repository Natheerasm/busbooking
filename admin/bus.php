...
<div class="container mt-0">
  <div class="row">
    ...
    ?>
      ...
      <h1 class="text-secondary text-center">ADD BUS DETAILS</h1>

      <form method="POST" class=" text-center" 
        action="../includes/admin/bus.inc.php">
        ...
        <div class="form-row">
          ...
          mysqli_stmt_execute($stmt);          
          $result = mysqli_stmt_get_result($stmt);    
          echo '<select class="travels col-md-3 mt-4" name="travels_name" style="border: 0px; border-bottom: 
            2px solid #5c5c5c; background-color: whitesmoke !important;">
            <option selected>Select Travels</option>';
          while ($row = mysqli_fetch_assoc($result)) {
            echo '<option value='. $row['travels_id']  .'>'. 
              $row['name'] .'</option>';
          }
        ?>
        </select>            
        ...
        <button name="bus_but" type="submit" 
