...
<footer>
	<em><h5 class="text-light text-center p-0 brand mt-2">
				<img src="assets/images/buslogo.png" 
					height="40px" width="40px" alt="">				
          Online bus Booking- Nico Travels </h5></em>
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Developed By Developed By HNDIT 2020 BATCH GROUP 04</p>
</footer>