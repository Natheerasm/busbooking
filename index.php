...
<style>
	...
	body {
		/*background: url('assets/images/sign.jpg') no-repeat 0px 0px;
...
<meta name="keywords" content="bus Ticket Booking  Widget Responsive, Login Form Web Template, Flat Pricing Tables, Flat Drop-Downs, Sign-Up Web Templates, Flat Web Templates, Login Sign-up Responsive Web Template, Smartphone Compatible Web Template, Free Web Designs for Nokia, Samsung, LG, Sony Ericsson, Motorola Web Design" />
...
<div class="main-agileinfo">
	<h1 class="text-light brand mt-2">
		<img src="assets/images/buslogo.png" height="105px" width="105px" alt="">
		Online bus Booking Nico Travels
	</h1>
	<div class="sap_tabs">
		<div id="horizontalTab">
			<ul class="resp-tabs-list">
				<li class="resp-tab-item"><span>Booking</span></li>
			...
			<div class="resp-tabs-container">
				<div class="tab-1 resp-tab-content roundtrip">
					<form action="book_flight.php" method="post">
						...
						<div class="clear"></div>
						<input type="submit" value="Search Ticket" name="search_but">
					</form>
				</div>
				...
				<footer class="mt-5">
					<em>
						<h5 class="text-light text-center p-0 brand mt-2">
							<img src="assets/images/.png" height="40px" width="40px" alt="">
							Online bus Booking- Nico Travels
						</h5>
					</em>
					<div class="text-light text-center">&copy; <?php echo date('Y') ?> - Developed By HNDIT 2020 BATCH GROUP 04<br><br></div>
